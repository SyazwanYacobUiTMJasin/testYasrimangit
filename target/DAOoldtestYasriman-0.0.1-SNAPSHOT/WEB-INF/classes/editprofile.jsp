  ...
  @media(max-width: 1034px)
 {
  ...
  <body>
    ...
    <div class="hero">
      ...
      <form
        id="profile-form"
        action="<%=request.getContextPath()%>/viewcustomeraccount?uid=${accounts.id}&from=edit"
        method="post"
        enctype="multipart/form-data"
      >
      
     <!--  --> <div style="display: none;">
	    <input type="text" name="accid" value="${accounts.id}" readonly/><input type="text" name="id" value="${loggedinaccountid}" readonly/>
		</div>

        <label for="profilepic">Profile Picture:</label>
        <input type="file" id="profilepic" name="profilepic" src="${accounts.picture}"/>
        ...
        <% if (request.getAttribute("postalcodeerror") != null) { %>
			    <p style="color:red;"><%= request.getAttribute("postalcodeerror") %></p>
			<% } %>
